...
def ensure_dataframe(
    ...
    *,
    ...
    if isinstance(data, pd.DataFrame):
        ...
        # Curated pandas suppression: ``data`` is intentionally ``object`` here
        # (a mapping/sequence coercible to a DataFrame); pandas-stubs has no
        # overload for ``object``, so we cast at this single boundary while the
        # rest of the function stays strictly typed.
